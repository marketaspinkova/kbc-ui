...
TableSizeLabel = React.createFactory(require('../../../../transformations/react/components/TableSizeLabel').default)
...
FiltersDescription = require('./FiltersDescription').default
